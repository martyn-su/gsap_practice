...
tl.to(".orange", { duration: 1, x: 200, rotation: -360, scale: .1, ease: "bounce"});
tl.to(".purple", { duration: 2, x: 500, rotation: 0, scale: 5, ease: "bounce"});
tl.to(".gray", { duration: 3, x: 1000, rotation: 130, scale: 3, ease: "bounce"});
tl.to(".green", { duration: 3, x: 800, rotation: 0, scale: .3, ease: "bounce" });
